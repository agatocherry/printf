...
MATH = libft/ft_atoi.c libft/ft_itoa.c libft/ft_antoi.c libft/ft_putuint.c
...
PRINTF = src/arguments.c \
		 ...
		 src/init.c \
		 src/printf.c \
		 src/percent.c src/char.c src/string.c src/int.c src/unsigned.c src/pointer.c src/hexa.c
