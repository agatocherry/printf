...
echo -e "\033[0m\033[3;37mPercent test\033[0m"

#Compile the test
gcc ../src/percent.c -D PRINT=printf && ./a.out > ../log/printf.log
gcc ../src/percent.c ../../libftprintf.a -D PRINT=ft_printf -Wall -Werror -Wextra -fsanitize=address -g3 && ./a.out > ../log/ft_printf.log
