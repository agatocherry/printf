...
#Compile the test
gcc ../src/string.c -D PRINT=printf && ./a.out > ../log/printf.log
gcc ../src/string.c ../../libftprintf.a -D PRINT=ft_printf -Wall -Werror -Wextra -fsanitize=address -g3 && ./a.out > ../log/ft_printf.log
