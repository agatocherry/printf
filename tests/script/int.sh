...
echo -e "\033[0m\033[3;37mInt test\033[0m"

#Compile the test
gcc ../src/int.c -D PRINT=printf -w && ./a.out > ../log/printf.log
gcc ../src/int.c ../../libftprintf.a -D PRINT=ft_printf -Wall -Werror -Wextra -fsanitize=address -g3 -w && ./a.out > ../log/ft_printf.log
