...
echo -e "\033[0m\033[3;37mHexa test\033[0m"

#Compile the test
gcc ../src/hexa.c -D PRINT=printf -w && ./a.out > ../log/printf.log
gcc ../src/hexa.c ../../libftprintf.a -D PRINT=ft_printf -Wall -Werror -Wextra -fsanitize=address -g3 -w && ./a.out > ../log/ft_printf.log
