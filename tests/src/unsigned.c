...
/*   Updated: 2021/05/12 15:58:49 by agcolas          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(void)
{
	...
	PRINT (" %d\n", PRINT ("17.test [%*.*u]", -20, 20, 4294967295));
	PRINT (" %d\n", PRINT ("18.a [%*.*u]", -444, 222, 4294967295));
	PRINT (" %d\n", PRINT ("19.a [%*.*u]", -444, 555, 4294967295));
	PRINT (" %d\n", PRINT ("20.a [%*.*u]", 5, 10, 7));
	PRINT (" %d\n", PRINT("36.a [%---34c]", 7));
	...
	PRINT (" %d\n", PRINT("39.a [%0-8.5u]", 34));
	PRINT (" %d\n", PRINT("39.x [%0-8.*u]", 5, 34));
	PRINT (" %d\n", PRINT("39.d [%0-8u]", 34));
	PRINT (" %d\n", PRINT("39.e [%0*u]", -8, 34));
	PRINT (" %d\n", PRINT("39.testa [%05u]", 34));
	PRINT (" %d\n", PRINT("39.testb [%.5u]", 34));
	PRINT (" %d\n", PRINT("39.c [%0*.5u]", -8, 34));
	PRINT (" %d\n", PRINT("39.y [%0*.*u]", -8, 5, 34));
	PRINT (" %d\n", PRINT("40 [%0-8.5u]", 0));
	PRINT (" %d\n", PRINT("41 [%0-3.7u]", 3267));
	return (0);
}
